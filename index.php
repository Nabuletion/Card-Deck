...
<body>
    ...
    <main class="container">
        <section class="d-block d-md-flex justify-content-around mb-2 mt-2">
            <!-- Normal Cards -->
            <section>
                <div class="h4 text-center">Normal Cards A, 1...9</div>
            ...
            <!-- Special Cards -->
            <section>
                <div class="h4 text-center">Special K, G, J, Joker</div>
                <div class="card_outline rounded sp_cards mx-auto">
                    <div class="face_value">
            ...
            <section>
                ...
                <div class="d-flex justify-content-between">
                    <div class="card_outline back_side rounded mx-auto">
                    </div>
                </div>
            </section>
            <!-- Back Side -->
            <section>
                ...
                <div class="hcard mt-1 mx-auto">
                    <button><img src="images/card-back.jpg" alt="" width="80px" height="50px"></button>
                    <button><img src="images/card-orange.png" alt="" width="90px" height="50px"></button>
                    <button><img src="images/card-red.jpg" alt="" width="90px" height="50px"></button>
                </div>
            </section>
        </section>
        <!-- Special Cards -->
